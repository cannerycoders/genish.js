...
const startWorkletNode = async function( wasmbuffer,  mem, 
            shouldPrint=false, shouldDebug=false, 
            path='../src/compiledWorklet.js', 
            isStereo=false ) 
{
  // console.assert(window.crossOriginIsolated === true); // server config
  if( init === false ) {
    try {
